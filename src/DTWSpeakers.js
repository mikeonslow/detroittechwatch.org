      ...
      <MDBContainer className="p-5 section dark">
        ...
        <MDBRow>
          ...
          <MDBCol size="8" className="text-left justify-content-center align-self-center">
            <p>In addition to the speakers we've lined up, we're actively looking for speakers for the Detroit Tech
              Watch for 2019.</p>
            ...
            <a href="schedule" id="schedule">
              <ul>
                <li>Generally we're looking for talks related to newer technologies that you're using at work to solve
                  real world problems
                </li>
