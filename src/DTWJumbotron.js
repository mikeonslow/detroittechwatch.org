          ...
          <MDBRow>
            ...
            <MDBCol className="col-12 col-lg-4 text-center text-lg-right">
              ...
              <h6 className="h6 brand-light">TechTown Detroit, 440 Burroughs Street, Detroit, MI 48202 <a
                  href="https://goo.gl/maps/itPsnYY7zBG2" target="_blank" rel="noopener noreferrer"
                  className="text-info"><MDBIcon icon="map-marked"/></a></h6>
            </MDBCol>
          </MDBRow>
          <MDBRow>
            <MDBCol>
          ...
          <MDBRow>
            <MDBCol>
              <MDBBtn outline color="primary"
                      size="lg"
                      id="eventbrite-widget-modal-trigger-58444259353">Purchase Tickets<MDBIcon icon="ticket-alt"
                                                                                                className="ml-2"/></MDBBtn>
            </MDBCol>
          </MDBRow>
        </MDBContainer>
    );
